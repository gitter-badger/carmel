...
var builder = {
    ...
    pageBuilder: function(context, gulp, plugins, locale, pagedata, streams) {
        ...
        streams.push(pageBuilder.buildHtml(context, gulp, plugins, locale, pagedata, htmlImports, function(err) {
          logger.error("HTML " + "error: " + err.message + " at line " + err.lineNumber + " in file "+ err.fileName);
        }));

        streams.push(pageBuilder.buildStyle(context, gulp, plugins, locale, pagedata, styleImports, function(err) {
          logger.error("SASS " + "error: " + err.message + " at line " + err.lineNumber + " in file "+ err.fileName);
        }));

        streams.push(pageBuilder.buildScripts(context, gulp, plugins, locale, pagedata, scriptsImports, function(err) {
          logger.error("JavaScript " + "error: " + err.message + " at line " + err.lineNumber + " in file "+ err.fileName);
        }));
    }
};
