  ...
  build: function(context, gulp, plugins) {
    ...
    locales.forEach(function(locale) {
      ...
      pages.forEach(function(pagedata) {
        ...
        plugins.util.log("- building components for page [" + pagedata.page + "/" + locale.id + "] ...");
  ...
  **/
  buildPageComponents: function(context, gulp, plugins, locale, pagedata) {
    ...
    components.forEach(function(component) {
      ...
      count++;
      // plugins.util.log("   + built", component.name);
    });
    plugins.util.log("  => SUCCESS", "- built " + count, "components");
