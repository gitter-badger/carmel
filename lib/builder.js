  ...
  build: function(context, gulp, plugins) {
    ...
    pages.forEach(function(pagedata) {
      ...
      components.forEach(function(component) {
        ...
        var componentTheme = '';
        for (key in component.theme) {
          var value = component.theme[key];
          componentTheme = componentTheme + "$" + key + ":" + value + ";\n";
        };

        // Create the custom style imports for this component
        imports = imports + "@import \"" + componentNewName + "/theme\"; \n";
        imports = imports + componentTheme;
