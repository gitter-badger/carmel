...
var loader = {
  ...
  **/
  loadComponentsMeta: function (pagedata, context, locale) {
    // pagedata['global'] = {
    //                         text: context.app.config.content.text,
    //                         locales: context.app.config.content.locales,
    //                         // assets: context.app.config.assets,
    //                         // settings: context.app.config.settings,
    //                         style: context.app.config.style
    //                         // links: context.app.config.links
    //                       };
  ...
  **/
  loadComponent: function (pagedata, componentId, context) {
  ...
  componentDistDir: function(component, locale) {
    ...
    var componentsDistDir = path.join(locale.tempDir, "components");
